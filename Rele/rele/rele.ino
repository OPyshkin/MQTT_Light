...
Adafruit_MQTT_Publish sensorDataSend = Adafruit_MQTT_Publish(&mqtt, "test/led");

// Setup a feed called 'onoff' for subscribing to changes.
Adafruit_MQTT_Subscribe sensorDataRecv = Adafruit_MQTT_Subscribe(&mqtt, "ctrl/relay");
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription())) {
    ...
    Serial.print(F("Got: "));
    String data = (char *)sensorDataRecv.lastread;
     Serial.println(data);
      if (data== "1")
      {
      digitalWrite(5, 1);
